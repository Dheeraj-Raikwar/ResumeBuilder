...
function Preview() {
  ...
  */
  ...
  const saveDetailsTodb = () => {
    ...
    experienceList.map((item, id) => {
    saveEducationDetails(item.institute,
      item.degree,
      item.fieldOfStudy,
      item.startYear,
      item.endYear,
    ...
    saveSkillsDetails("skillarray" ,skillarray)
  ...
  const saveExpDetails = (job_title,
    company,
    isworking,
    start_month,
    start_year,
  ...
  const saveEducationDetails = (institute,
    degree,
    field_of_study,
    start_year,
    end_year,
  ...
  const saveSkillsDetails = (skillArr) => {
      ...
      <div className='template-container'>
        ...
        <div className='template1'>
          ...
          <div className="d-grid col-2 mx-auto mt-4">
            <button className="nav-link align-middle bg-dark text-white p-2 rounded" onClick={printDocument1}>Download Template 1</button>
          </div>
        </div>
